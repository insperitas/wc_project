...
import { healthCheck, registerUser, loginUser, logout, getMe } from './api'
...
export default function App() {
  ...
  return (
    <div className="container">
      ...
      <p>Cleaner dashboard starter — expand to show jobs, accept/decline, profile, and availability.</p>
